...
tile_above = place_meeting(x, y-adj, obj_rock_tile);
tile_below = place_meeting(x, y+adj, obj_rock_tile);
tile_left = place_meeting(x-adj, y, obj_rock_tile);
tile_right = place_meeting(x+adj, y, obj_rock_tile);
